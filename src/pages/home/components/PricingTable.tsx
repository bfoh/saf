      ...
      <section id="pricing" className="py-24 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          ...
          <div
            ...
            className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 items-stretch"
          >
            {PLANS.map((plan, index) => (
              <div
                key={plan.level}
                className={`relative flex flex-col rounded-2xl overflow-hidden border transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl ${
              ...
              >
                {/* Badge */}
                {plan.badge && (
                  <div className={`absolute top-4 right-4 text-xs font-bold px-3 py-1 rounded-full whitespace-nowrap z-10 ${
                    plan.badge === 'Most Popular'
                ...
                <div className="bg-white px-6 pb-6 pt-2">
                  <button
                    ...
                    className={`w-full py-3 rounded-xl font-semibold text-sm transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] cursor-pointer whitespace-nowrap ${
                      plan.badge === 'Most Popular'
