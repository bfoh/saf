...
export default function Home() {
  ...
  return (
    <div className="relative bg-[#F6F9F3] overflow-hidden">
      ...
      <div
        className={`fixed bottom-8 right-6 z-50 flex flex-col items-end gap-3 transition-all duration-500 ${
          showFloatingBtn
      ...
      >
        ...
        <a
          ...
          className="group flex items-center gap-2 bg-[#25D366] text-white font-semibold text-sm px-5 py-3 rounded-full shadow-xl hover:shadow-2xl hover:scale-105 active:scale-95 transition-all duration-300 whitespace-nowrap cursor-pointer"
        ...
        <div className="relative">
          <button
            ...
            className="group flex items-center gap-2 bg-[#C7F000] text-[#0F6B3E] font-semibold text-sm px-5 py-3 rounded-full shadow-xl hover:shadow-2xl hover:scale-105 active:scale-95 transition-all duration-300 whitespace-nowrap cursor-pointer"
